...
type KakaoSignInInfo = {
  provider: "KAKAO";
  profile: Awaited<ReturnType<typeof getKakaoProfile>>;
  token: Awaited<ReturnType<typeof kakaoLogin>>;
};

type AppleSignInInfo = {
  provider: "APPLE";
...
export default function OnboardingScreen() {
  ...
  function formatAppleFullName(credential: AppleAuthenticationCredential) {
  ...
  async function signInWithApple(): Promise<AppleSignInInfo> {
  ...
  async function signInWithKakao(): Promise<KakaoSignInInfo> {
  ...
  async function getSocialSignInInfo(
    provider: AuthProvider,
  ): Promise<SocialSignInInfo> {
    switch (provider) {
      case "APPLE":
  ...
  async function handleSocialSignIn(provider: AuthProvider) {
    ...
    try {
      const socialSignInInfo = await getSocialSignInInfo(provider);
      console.log("[social-sign-in]", socialSignInInfo);
